        ...
        <div className="top-container">
            ...
            <Manager>
                ...
                {({ ref, style, placement, arrowProps }) => ( isSelectLocationOpen &&
                    <div className="popup-container" ref={ref} style={{...style, top: "-10px"}} data-placement={placement}>
                    
                    <div className="form-container">
                        <label htmlFor="location-name">Location Name</label>
                        <input id="location-name"  onChange={this.onLocationNameChange.bind(this)} type="text" placeholder="City Name" ></input>
